...
import 'package:flutter_application_1/volunteer/accepted_requests.dart';
import 'dart:io';
...
class _VolunteerRegistrationPageState extends State<VolunteerRegistrationPage> {
  ...
  Future<void> _registerVolunteer() async {
    ...
    if (selectedRole == null ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text(
                "Please fill in all required details and upload KYC document."),
            backgroundColor: Colors.red),
      );
      return;
    }
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text(
                "Your registration is being analyzed! We will get to you soon"),
 ...
 Widget _buildStatusMessage() {
  ...
  // The animation and message based on the approval status
  switch (approvalStatus) {
    case "approved":
      message =
          "You're an approved volunteer! You'll receive notifications when a user needs your help.";
      animation = Lottie.asset("assets/animations/tick.json",
    ...
    case "declined":
      message =
          "Unfortunately, your registration was declined. But you can still request help when needed.";
      animation = Lottie.asset("assets/animations/reject1.json",
          width: 200, repeat: false);
      break;
    default:
      message = "Thank you for registering! Your request is being reviewed.";
      animation = Lottie.asset("assets/animations/pending.json",
          width: 200, repeat: false);
  }

  // Default container for all cases
  return Container(
    decoration: const BoxDecoration(
      gradient: LinearGradient(
        colors: [Colors.purple, Colors.pink, Colors.orange],
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (kycFile != null)
                            const Text("KYC Document Selected",
